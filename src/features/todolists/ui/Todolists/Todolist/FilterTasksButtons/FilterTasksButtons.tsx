...
export const FilterTasksButtons = ({todolist}: Props) => {
    ...
    return (
        <Box sx={filterButtonsContainerSx}>
            <MyButton variant={todolist.filter === 'all' ? 'contained' : 'outlined'}
                      onClick={changeFilterHandlerCreator(todolist.id, 'all')} title={'All'}/>
            <MyButton variant={todolist.filter === 'active' ? 'contained' : 'outlined'}
                      onClick={changeFilterHandlerCreator(todolist.id, 'active')} title={'Active'}/>
            <MyButton variant={todolist.filter === 'completed' ? 'contained' : 'outlined'}
                      onClick={changeFilterHandlerCreator(todolist.id, 'completed')} title={'Completed'}/>
        </Box>
    );
};
